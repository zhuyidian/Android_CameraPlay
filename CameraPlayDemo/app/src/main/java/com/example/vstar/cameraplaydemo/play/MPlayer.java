 ...
 */
package com.example.vstar.cameraplaydemo.play;
...
public class MPlayer implements IMPlayer,MediaPlayer.OnBufferingUpdateListener,
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        Log.e("ydzhu","surfaceCreated---holder="+holder);
        if(display!=null&&holder==display.getHolder()){
            Log.e("ydzhu","surfaceCreated---1---holder="+holder);
    ...
    public void surfaceDestroyed(SurfaceHolder holder) {
        Log.e("ydzhu","surfaceDestroyed---holder="+holder);
        if(display!=null&&holder==display.getHolder()){
            Log.e("ydzhu","surfaceDestroyed---holder="+holder);
