...
import com.example.vstar.cameraplaydemo.DecoderGLSurfaceActivity;
...
public class DecoderGLSurfaceView extends GLSurfaceView {
    private static final String TAG = "MyGLSurfaceView";
	private DecoderGLSurfaceActivity context;
    public MyRenderer renderer;
	
    int screenWidth, screenHeight;
    boolean playing;

    public DecoderGLSurfaceView(Context context, AttributeSet attri) {
		super(context, attri);
		this.context = (DecoderGLSurfaceActivity)context;
		init(context);
    }
    
    public DecoderGLSurfaceView(Context context) {
		super(context);
		this.context = (DecoderGLSurfaceActivity)context;
		init(context);
    }
    ...
    class MyRenderer implements Renderer {
		...
		private FloatBuffer verticesBuffer, textureVerticesPreviewBuffer;
		...
		void initTexture() {
			...
			vertShader = IVCGLLib.loadFromAssetsFile("IVC_VShader_Preview.sh", context.getResources());
			fragShader_Pre = IVCGLLib.loadFromAssetsFile("IVC_FShader_Preview.sh", context.getResources());
