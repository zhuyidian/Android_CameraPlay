 ...
 */
public class GL2JNISurfaceView extends GLSurfaceView {
    ...
    public GL2JNISurfaceView(Context context, boolean translucent, int depth, int stencil) {
        super(context);
    ...
    private static class ContextFactory implements GLSurfaceView.EGLContextFactory {
        ...
        @Override
        public javax.microedition.khronos.egl.EGLContext createContext(EGL10 egl, EGLDisplay display, javax.microedition.khronos.egl.EGLConfig eglConfig) {
            checkEglError("Before eglCreateContext", egl);
            int[] attrib_list = {EGL_CONTEXT_CLIENT_VERSION, 2, EGL10.EGL_NONE };
            javax.microedition.khronos.egl.EGLContext context = egl.eglCreateContext(display, eglConfig, EGL10.EGL_NO_CONTEXT, attrib_list);
    ...
    private static class Renderer implements GLSurfaceView.Renderer {
        public void onDrawFrame(GL10 gl) {
            ImageUtilEngine.stepGL2();
        }

        public void onSurfaceChanged(GL10 gl, int width, int height) {
            ImageUtilEngine.initGL2(width, height);
        }
